...
CREATE TABLE DATA_TEAM.Inmueble_Caracteristica (
	...
	INMUEBLE_CARACTERISTICA_INMUEBLE NUMERIC(18,0),
...
INSERT INTO DATA_TEAM.Inmueble_Caracteristica SELECT 
INMUEBLE_CODIGO,
...
FROM gd_esquema.Maestra
WHERE INMUEBLE_CARACTERISTICA_WIFI IS NOT NULL
...
INSERT INTO DATA_TEAM.Propietario SELECT 
PROPIETARIO_NOMBRE,
...
INSERT INTO DATA_TEAM.Anuncio SELECT 
ANUNCIO_CODIGO,
