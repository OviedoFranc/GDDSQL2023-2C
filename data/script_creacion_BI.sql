...
CREATE TABLE DATA_TEAM.BI_D_RANGO_ETARIO (
    RANGO_ETARIO_ID NVARCHAR(100) NOT NULL PRIMARY KEY,
...
CREATE TABLE DATA_TEAM.BI_H_ANUNCIO (
    ...
    ANUNCIO_RANGO_METROS NVARCHAR(100) NOT NULL FOREIGN KEY REFERENCES DATA_TEAM.BI_D_RANGO_METROS,
...
CREATE TABLE DATA_TEAM.BI_H_VENTA (
    ...
    VENTA_RANGO_ETARIO NVARCHAR(100) NOT NULL FOREIGN KEY REFERENCES DATA_TEAM.BI_D_RANGO_ETARIO,
    ...
    VENTA_RANGO_METROS NVARCHAR(100) NOT NULL FOREIGN KEY REFERENCES DATA_TEAM.BI_D_RANGO_METROS,
...
CREATE TABLE DATA_TEAM.BI_H_ALQUILER (
    ...
    ALQUILER_RANGO_ETARIO NVARCHAR(100) NOT NULL FOREIGN KEY REFERENCES DATA_TEAM.BI_D_RANGO_ETARIO,
